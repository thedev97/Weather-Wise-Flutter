...
class WeatherBloc extends Bloc<WeatherBlocEvent, WeatherBlocState> {
  ...
  Future<void> _onFetchWeather(FetchWeather event, Emitter<WeatherBlocState> emit) async {
  ...
  Future<void> _onFetchWeatherByCity(FetchWeatherByCity event, Emitter<WeatherBlocState> emit) async {
    emit(WeatherBlocLoading());
    try {
      WeatherFactory wf = WeatherFactory(API_KEY, language: Language.ENGLISH);
